                ...
                children: [
                  IconButton(
                    ...
                    onPressed: () {
                      ...
                      _editHistory(context, entry);
                    },
                  ),
                  IconButton(
                    icon: Icon(Icons.delete),
                    onPressed: () async {
                      await deleteHistory(entry['id'], context);
                    },
                  ),
                ],
              ),
...
Future<void> _editHistory(BuildContext context, Map entry) async {
        ...
        actions: <Widget>[
          ...
          TextButton(
            ...
            onPressed: () async {
              ...
              await updateHistory(entry['id'], num1Controller.text, num2Controller.text, operationController.text, context);
            },
          ),
        ],
      );
...
Future<void> updateHistory(int id, String num1, String num2, String operation, BuildContext context) async {
...
Future<void> deleteHistory(int id, BuildContext context) async {
